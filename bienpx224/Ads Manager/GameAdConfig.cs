...
public class GameAdConfig
{
    [Header("UnityAds")]
#if UNITY_ANDROID
    public const string ID_UNITY = "1111111";
#else
    public const string ID_UNITY = "1111112";
#endif

    public const string INTER_UNITY = "video";
    public const string VIDEO_UNITY = "rewardedVideo";
#if !CHEAT
#if UNITY_ANDROID
